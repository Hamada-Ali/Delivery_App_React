    ...
    <section className="w-full my-6" id="menu">
      <div className="w-full flex flex-col item-center justify-center">
        <p
          ...
          relative before:absolute before:rounded-lg before:content before:w-16 before:h-1 before:-bottom-2 before:left-0 before:bg-orange-500
          transition-all ease-in-out duration-100 from-orange-400 to-orange-600 "
        >
          Our Host Dishes
        </p>
        <div className="w-full flex items-center py-6 justify-start lg:justify-center gap-8 mt-6 overflow-x-scroll scrollbar-none">
          {categories &&
            categories.map((category) => (
              ...
              onClick={() => setFilter(category.urlParamName)}
                ...
                }  bg-card w-24 h-28 min-w-[94px] cursor-pointer rounded-lg drop-shadow-xl flex flex-col gap-3 items-center justify-center 
     hover:bg-cartNumBg`}
              >
                <div
